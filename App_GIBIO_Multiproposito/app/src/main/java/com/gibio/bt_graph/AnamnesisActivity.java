...
public class AnamnesisActivity extends Activity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private EditText etTalla, etBMI, etPreSis, etPreDia, etVOP1, etVOP2;
    ...
    void ObjetosInit(){
        ...
        etVOP1=(EditText)findViewById(R.id.etVOP1);
        etVOP2=(EditText)findViewById(R.id.etVOP2);
    ...
    void Cargar_Datos(){
        ...
        SignosVitales = "Signos Vitales: "+"-------------------------"+"\n"+"FC: "+etFC.getText()+"\n"+"TA: "+etTA.getText()+"\n"+
                    ...
                    "Presión Diastólica: "+etPreDia.getText()+"\n"+ "VOP C. Femoral: "+etVOP1.getText()+"\n" + "VOP C. Radial: "+etVOP2.getText()+"\n";
